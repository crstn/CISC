...
p = pop.openTIFFasNParray(os.path.expanduser('~') + '/Dropbox/CISCdata/Population2010Raster/Pop_2010_clipped.tiff')
pync.Notifier.notify('Reading urban/rural raster', title='Python')
u = pop.openTIFFasNParray(os.path.expanduser('~') + '/Dropbox/CISCdata/GLURRaster/GRUMP_UrbanRural.tiff')
pync.Notifier.notify('Reading cities raster', title='Python')
c = pop.openTIFFasNParray(os.path.expanduser('~') + '/Dropbox/CISCdata/SDEI-Global-UHI/sdei-global-uhi-2013.tiff')
...
pop.array_to_raster(noPop, os.path.expanduser('~') + '/Desktop/noPop-1.tiff', os.path.expanduser('~') + '/Dropbox/CISCdata/Population2010Raster/Pop_2010_clipped.tiff')
...
pop.array_to_raster(noPopInCities, os.path.expanduser('~') + '/Desktop/noPopInCities.tiff', os.path.expanduser('~') + '/Dropbox/CISCdata/Population2010Raster/Pop_2010_clipped.tiff')
