# ----------------------------------------------------------------------------
# DESCRIPTION:  THIS FILE HAS BEEN CHANGE FROM THE ORIGINAL IT WILL NOT DO THAT IT CLAIMS
#
#               This file calls the functions in Script 1, which list the dbf
...
for land in land_use_models:
    ...
    for paths in paths_dbf_folders:
        ...
        path_to_csv_folder = create_directory(urban_folder_path, "csv_files")
    ...
    print "Finished processing %d %s files in %d minutes"% (count, land, final_time_hours)
