...
# SUMMARIZES THE INFORMATION INTO NATIONAL LEVEL UNITS WITH TAGS FOR ALLOWING REGIONAL, SUB-
# REGIONAL, WORLD BANK INCOME STATUS AND OTHER AGGREGATIONS.  THE DATA ARE STORED AS SUMMARY
# FILES IN "*_HI_FINAL/SUMMARY_TABLES" FOLDERS.  THE SCRIPT CAN BE RUN ONCE FOR BOTH 
...
group_names_5<-list("urban_code", "ISO", "Year")
dots5<-lapply(group_names_5, as.symbol)

group_names_6<-list("ISO", "Year", "Heat_Index_cat")
dots6<-lapply(group_names_6, as.symbol)

group_names_7<-list("ISO", "Year", "Heat_Index_cat_UHI")
