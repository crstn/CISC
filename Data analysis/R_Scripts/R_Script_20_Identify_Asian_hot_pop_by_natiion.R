...
start_folder<-"E:/July_2017/Pop_&_Temp/GlobCover_HI/GlobCover_HI_Final/Summary_tables/Population/15_day"
setwd(start_folder)

# make path to final folder (created this folder previously)
final_path<-"E:/July_2017/Pop_&_Temp/GlobCover_HI/GlobCover_HI_Final/Summary_tables/Population/15_day/Asia"
