...
##      ggsave(filename=full_path, plot=plot_2,  width = 10, height = 7, units = "in",  dpi = 300)      
      ...
      file_name<-paste (land_use_name, rcp_number, heat_wave_number, "national_temperature.csv", sep = "_")
      ...
      # Create name for table file
      file_name<-paste (land_use_name, rcp_number, heat_wave_number, "sub_regional_temperature.csv", sep = "_")
      full_file_path<-paste(final_HI_table_directory, file_name, sep = "/")
      ...
      # Create name for table file
      file_name<-paste (land_use_name, rcp_number, heat_wave_number, "regional_temperature.csv", sep = "_")
      full_file_path<-paste(final_HI_table_directory, file_name, sep = "/")
...
##      ggsave(filename=full_path, plot=plot_3,  width = 10, height = 7, units = "in",  dpi = 300)      
      ...
      # Create name for table file
      file_name<-paste (land_use_name, rcp_number, heat_wave_number, "global_temperature.csv", sep = "_")
      full_file_path<-paste(final_HI_table_directory, file_name, sep = "/")
...
# Create name for table file
file_name<-paste (land_use_name, rcp_name, heat_wave_name, "regional_temperature.csv", sep = "_")
full_file_path<-paste(final_table_directory, file_name, sep = "/")

# Save dataframe
write.csv(l_chart_file_1a, file = full_file_path, row.names = FALSE)

# Summarize data by Year & SUB-REGION 
l_chart_file_1b<-new_file%>%
  group_by_(.dots = dots5) %>%
  summarize(Urban_extents = n(),
            Population = sum(as.numeric(Population)),
...
# Create name for table file
file_name<-paste (land_use_name, rcp_name, heat_wave_name, "sub_regional_temperature.csv", sep = "_")
full_file_path<-paste(final_table_directory, file_name, sep = "/")
