#run the script as "citiesCalc.py" for calculation of all cities or
#"citiesCalc.py 'Moscow' 'New York' etc. for calculation of those cities.
...
datadir = os.path.expanduser('~') + '/Dropbox/CISC Data/SDEI-Global-UHI'

# Make sure we don't overwrite an existing citiesPop.csv, this one takes
# hours to generate!
if (len(sys.argv) == 0) and (os.path.exists(datadir+'/citiesPop.csv')):
    print "citiesPop.csv already exists. If you want to recalculate it, delete it first."
    sys.exit()
